      ...
      <main className="flex-1 flex items-center justify-center p-6">
        <Card className="w-full max-w-md">
          <CardHeader className="space-y-1">
            ...
            <CardDescription>Try NextYou with a demo account. No registration required.</CardDescription>
          </CardHeader>
          ...
          <CardFooter className="flex flex-col space-y-4">
            <Button onClick={handleGuestLogin} className="w-full bg-rose-500 hover:bg-rose-600" disabled={isLoading}>
              {isLoading ? (
                <>
