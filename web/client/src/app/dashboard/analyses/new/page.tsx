...
export default function NewAnalysisPage() {
  return (
    <DashboardShell>
      ...
      <PageHeader heading="New Analysis" description="Upload your ChatGPT history to start analysis" />

      <Card>
        <CardHeader>
          <CardTitle>Upload ChatGPT History</CardTitle>
          <CardDescription>Upload a JSON file to start analysis</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="rounded-md bg-muted p-4">
            ...
            <ol className="mt-2 space-y-2 text-sm text-muted-foreground">
              ...
              <li>3. Extraction of key areas of interest and thought patterns</li>
