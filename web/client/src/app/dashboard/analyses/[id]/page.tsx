        ...
        <TabsContent value="summary" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Key insights from your ChatGPT history</CardDescription>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground mb-4">
                This analysis examined your ChatGPT conversation history from the past 30 days. Conversations primarily
                focused on programming learning and health management, with frequent questions about React and
                TypeScript in particular. There's also growing interest in improving morning routines.
              </p>
              ...
              <div className="rounded-md bg-muted p-4">
                ...
                <ul className="mt-2 space-y-2 text-sm">
                  ...
                  <li>• Tendency to make learning plans but may struggle with execution</li>
                  <li>• Beginning to recognize the connection between health and productivity</li>
          ...
          <ObjectRelationship title="Related Action Plans" description="Action plans suggested based on this analysis">
            ...
            <div className="col-span-full md:col-span-1 flex items-center justify-center border border-dashed rounded-lg p-8">
              <Button variant="outline" asChild className="h-auto flex flex-col p-6 gap-2">
                <Link href={`/dashboard/action-plans/new?analysisId=${analysis.id}`}>
            ...
            <Card key={interest.name}>
              ...
              <CardContent>
                <div className="w-full bg-muted rounded-full h-2.5 mb-4">
                  <div className="bg-primary h-2.5 rounded-full" style={{ width: `${interest.percentage}%` }} />
                </div>
