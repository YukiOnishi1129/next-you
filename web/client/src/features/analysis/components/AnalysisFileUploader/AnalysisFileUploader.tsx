  ...
  return (
    <div className="space-y-4">
      <div className="grid w-full max-w-sm items-center gap-1.5">
        ...
        <Input id="chatgpt-json" type="file" accept=".json" onChange={handleFileChange} />
      </div>
      {file && (
      ...
      <Button onClick={handleUpload} disabled={!file || uploading} className="w-full bg-rose-500 hover:bg-rose-600">
        {uploading ? (
          <>
